...
public juce::DragAndDropTarget,
    ...
    public:
        ...
        void selectAll();
        void deselectAll();
        void clearAllClips(bool showConfirmation = true);
        ...
        // Allow command classes to access clips
        friend class TrackAddClipCommand;
        friend class TrackDeleteClipsCommand;
        friend class TrackMoveClipsCommand;
        friend class TrackResizeClipCommand;
